...
class dataUploadView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            data_smoker=request.POST.get('smoker')
            ...
            data = np.array([data_age,data_sex,data_bmi,data_children,data_smoker])
            #sc = StandardScaler()
...
#data_for_prediction =obj.pca(np.array(data_for_prediction),y_test)
            ...
            return render(request, "succ_msg.html", {'data_age':data_age,'data_sex':data_sex,'data_bmi':data_bmi,'data_children':data_children,'data_smoker':data_smoker,
                                                        'out':out})
